  ...
  return (
   <section className="hero">
      ...
      <div className = "herotext">
        ...
        <nav>
          <ul id = "nav-list">
               <li className="nav"> <a className="hero1" href="#About"> About </a> </li>
               <li className="nav"> <a className="hero1" href="#Project">Projects  &nbsp;  </a></li>
               <li className="nav"> <a className="hero1" href="#Contact"> Contact</a></li>
           </ul>
